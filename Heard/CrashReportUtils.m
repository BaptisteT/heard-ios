...
//  Heard
//
//  Created by Baptiste Truchot on 7/4/14.
...
+ (void)handleCrashReport {
    ...
    if (crashData) {
        ...
        if (report) {
            NSString * reportString = [self stringValueForCrashReport:report withTextFormat:PLCrashReportTextFormatiOS];
            [ApiUtils sendCrashData:reportString andExecuteSuccess:nil failure:nil];
        }
    }
